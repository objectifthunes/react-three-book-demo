...
export function Brand() {
  return (
    <Link href="/" className="brand" aria-label="@objectifthunes/react-three-book home">
      ...
      <span className="brand__text">
        <span className="brand__eyebrow">LIBRARY · REACT</span>
        <span className="brand__name">@objectifthunes/react-three-book</span>
